...
('default','forum_weight_cfg_07','global','default','post_stance_weights.default','{"agree_amplify":0.25,"cautious_accept":0.2,"evidence_skeptic":0.15,"priority_redirect":0.12,"protective_pushback":0.1,"contextualize_memory":0.08,"fandom_fatigue":0.06,"meme_deflect":0.04}'::jsonb,'{}'::jsonb,now(),now()),
('default','forum_weight_cfg_08','global','default','post_stance_weights.rumor_group','{"agree_amplify":0.18,"cautious_accept":0.2,"evidence_skeptic":0.22,"protective_pushback":0.14,"fandom_fatigue":0.1,"contextualize_memory":0.08,"priority_redirect":0.06,"meme_deflect":0.02}'::jsonb,'{}'::jsonb,now(),now()),
('default','forum_weight_cfg_09','global','default','post_stance_weights.career_group','{"agree_amplify":0.28,"contextualize_memory":0.18,"evidence_skeptic":0.16,"priority_redirect":0.14,"cautious_accept":0.12,"fandom_fatigue":0.06,"protective_pushback":0.04,"meme_deflect":0.02}'::jsonb,'{}'::jsonb,now(),now()),
('default','forum_weight_cfg_10','global','default','post_stance_weights.state_group','{"protective_pushback":0.24,"priority_redirect":0.18,"cautious_accept":0.18,"evidence_skeptic":0.12,"contextualize_memory":0.12,"agree_amplify":0.1,"fandom_fatigue":0.04,"meme_deflect":0.02}'::jsonb,'{}'::jsonb,now(),now()),
('default','forum_weight_cfg_11','global','default','knowledge_level_limits','{"surface":{"maxHistoryDigests":0,"maxInterpretationFrames":0,"recentDays":0},"recent":{"maxHistoryDigests":1,"maxInterpretationFrames":0,"recentDays":14},"deep":{"maxHistoryDigests":2,"maxInterpretationFrames":0,"recentDays":3650},"legacy":{"maxHistoryDigests":3,"maxInterpretationFrames":1,"recentDays":3650}}'::jsonb,'{}'::jsonb,now(),now())
